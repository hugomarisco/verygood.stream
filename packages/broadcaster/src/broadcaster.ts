var STREAM_PORT = process.argv[2] || 3333,
  WEBSOCKET_PORT = process.argv[3] || 9000;
...
console.log(
  "Listening for incomming MP4 Stream on tcp://127.0.0.1:" + STREAM_PORT + "/"
);
console.log(
