...
describe("SwarmId", () => {
  test("should correctly parse the public key exponent and modulus for RSASHA1", () => {
    ...
    expect(swarmId.exponent).toEqual(Buffer.from("AQAB", "base64"));
  });
});
